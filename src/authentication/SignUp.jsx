          ...
          <Col md={6} className="auth-image-side d-none d-md-flex align-items-center justify-content-center text-white">
            <div className="text-center p-5">
              ...
              <p className="lead mb-4">
                Create an account to discover and support local businesses in your community
              </p>
              <img 
                ...
                <Form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <Form.Group className="mb-4">
                    <Form.Check
                      ...
                      label={
                        <span>I agree to the <Link to="/terms" className="text-primary">Terms and Conditions</Link></span>
                      }
                    />
                    {errors.terms && (
                  ...
                  <div className="text-center">
                    <p className="mb-0">
                      ...
                      <Link to="/auth/login" className="text-primary text-decoration-none">
                        Login
                      </Link>
                    </p>
                  </div>
